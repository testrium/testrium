...
import { FolderOpen, TrendingUp, CheckCircle2, FolderKanban, FileText, Layers } from 'lucide-react';
            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {projects.map((project) => (
                  <Card key={project.id} className="border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm cursor-pointer">
